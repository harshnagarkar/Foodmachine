...
class Cuisine(models.Model):
    ...
    Cuisine_Pic = models.ImageField(
        upload_to='media/', default='/media/defaultimage.png')
...
class Restaurant(models.Model):
    ...
    Cuisine_Type = models.ForeignKey(
        Cuisine, on_delete=models.SET_NULL, null=True, default=None)
...
class Menu(models.Model):
    ...
    Menu_Res_Id = models.ForeignKey(
        Restaurant, on_delete=models.CASCADE, null=False, blank=False, default=None)
    Menu_Cuisine = models.ForeignKey(
        Cuisine, on_delete=models.SET_NULL, null=True, default=None)
    Menu_Label_Id = models.ForeignKey(
        Label, on_delete=models.SET_NULL, null=True)
    Menu_Pic = models.ImageField(
        upload_to='media/', default='defaultimage.png')
